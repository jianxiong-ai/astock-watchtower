...
- FastAPI 后端
  ...
  - 行业 provider v1：把外部行业读数以统一结构注入行业骨架；首批支持有色/矿业的铜价与铜链板块温度、保险的同业表现与保险板块温度，并明确保留 TC/RC、库存升贴水、国债收益率、A/H 溢价等 Missing Inputs
...
- 行业 provider v1：在财报/公告抽取之外，为行业骨架补充外部读数。当前首批 provider 包括：
  ...
  - 保险：Sina 二级行情中的中国人寿、中国平安、中国太保、中国人保同业表现，Eastmoney 保险板块温度；中国 10 年国债收益率、收益率曲线、A/H 溢价和 H 股同步行情仍明确 Missing。
